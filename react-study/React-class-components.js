...
// rendered as yellow (because the method updates the state with the color from
...
// ** Nothing happens, there are no changes when the button is clicked **
...
// ** This once changes from "red" to "blue" as spected **
...
// In the getSnapshotBeforeUpdate() method you have access to the props and
// state before the update, meaning that even after the update, you can check
...
// becomes "yellow". This action triggers the update phase, and since this
// component has a componentDidUpdate method, this method is executed and writes
// a message in the empty DIV element:
